...
"""Configuration file for the Sensor Harmonization (Landsat-8 and Sentinel-2) documentation.
...
html_title = 'SENSOR_HARM'

html_context = {
    'display_github': False,
    'github_user': 'brazil-data-cube',
    'github_repo': 'sensor-harm',
    'last_updated': False,
    #'commit': False,
}
...
#import os
#
#SENSOR_HARM_EXAMPLE_URL = os.getenv('SENSOR_HARM_EXAMPLE_URL', None)
#'''
